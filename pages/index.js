...
const styles = {
  container: 'padding-left-xl padding-right-xl',
  ...
  subtitle: 'color-black font-size-m font-weight-600 margin-left-m margin-top-m',
  description: 'text-align-center margin-m margin-top-xl line-height-m font-size-s',
